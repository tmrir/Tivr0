...
export const SettingsPage: React.FC = () => {
  ...
  // Now the UI will render immediately with default values if loading.
  ...
  // Ensure settings exists before render
  if (!settings) return null; 

  return (
    <div className="max-w-5xl mx-auto relative">
        {/* Show loading spinner overlay if fetching but still show content */}
        {loading && (
